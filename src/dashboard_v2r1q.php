        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item"><a class="nav-link active" href="dashboard_v2r1q.php">Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link" href="profile_x8d9s.php">Profile</a></li>
                    <li class="nav-item"><a class="nav-link" href="settings_b6n7m.php">Settings</a></li>
                </ul>
